package com.vot.audioplayer.media.exoplayer
...
internal class MediaPlayerNotificationManager(
    ...
    init {
        ...
        val builder = PlayerNotificationManager.Builder(
            context,
            S.PLAYBACK_NOTIFICATION_ID,
            S.PLAYBACK_NOTIFICATION_CHANNEL_ID
        )
        ...
        with(builder) {
            ...
            setChannelNameResourceId(R.string.notification_channel_description)
        }
